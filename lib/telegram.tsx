 ...
 *    - TELEGRAM_BOT_TOKEN="8547931381:AAHi3H1pXkM72G0nW6_LkpX6thbFs3cqHaQ"
 *    - TELEGRAM_CHAT_ID="6209011934"
 *
...
export async function sendTelegramNotification(activity: UserActivity) {
  try {
    ...
    const botToken = "8547931381:AAHi3H1pXkM72G0nW6_LkpX6thbFs3cqHaQ"
    const chatId = "6209011934"
